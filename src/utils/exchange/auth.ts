...
export async function getLyraAuthHeader(wallet: ethers.BaseWallet, signer?: ethers.BaseWallet): Promise<LyraAuthHeader> {
...
export async function getLyraAuthMessage(wallet: ethers.BaseWallet, signer?: ethers.BaseWallet): Promise<LyraAuthMessage> {
